...
def train():
    ...
    if opt.transfer or opt.prebias:  # transfer learning edge (yolo) layers
        nf = int(model.module_defs[model.yolo_layers[0] - 1]['s'])  # yolo layer size (i.e. 255)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', type=int, default=1000)  # 500200 batches at bs 16, 117263 images = 273 epochs
